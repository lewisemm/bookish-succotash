                ...
                <div data-reactroot=''>
                  <div className='following-metadata'>
                    <span className='following-count'>
                      <span>
                        <span><b>{items.profile.user.following.length}</b> Following</span>
                      </span>
                    </span>
                    <span className='follower-count'>
                      <span>
                        <span><b>{items.profile.user.followers.length}</b> Followers</span>
                      </span>
                    </span>
                  </div>
        ...
        <div className='posts-wrapper animated fadeInUp' data-animation='fadeInUp-fadeOutDown'>
          ...
          { items.profile.articles.map((article) => {
            <div className='post-panel'>
              ...
              { article.feature_img.length > 0 ? <div className='post-picture-wrapper'><img src={article.feature_img} alt='alt'/></div> : ''}
              <div className='main-body'>
                <h3 className='post-title'><a href={`/articleview/${article._id}`}></a></h3>
                  ...
                  <div className='bookmark-button-wrapper'>
                    <form className='button_to' method='get' action=''>
                      <button className='bookmark-button' data-behaviour='trigger-overlay' type='submit'>
                        <span className='icon-bookmark-o'>Like</span>
