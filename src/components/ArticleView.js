        ...
        <div className='container-fluid main-container'>
          <div className='row animated fadeInUp' data-animation='fadeInUp-fadeOutDown'>
            <div id='main-post' className='col-xs-10 col-md-8 col-md-offset-2 col-xs-offset-1 main-content'>
              ...
              { !feature_img || !feature_img.length > 0 ? '': <div className='post-picture-wrapper'><img src={feature_img} alt='feature img 540'/></div> }
              ...
              <div className='post-stats clearfix'>
                <div className='pull-left'>
                  <div className='like-button-wrapper'>
                    <button onClick={() => this.props.clap(this.props.article._id)} className='like-button' data-behaviour='trigger-overlay' type='submit'>
                ...
                <div className='pull-left'>
                  <a className='response-icon-wrapper' href="#">
                    ...
                    <span className='response-count' data-behaviour='response-count'>0</span>
                  </a>
                </div>
                <div className='pull-right'>
                  <div className='bookmark-button-wrapper'>
                    <form className='button_to' method='get' action=''>
                      <button className='bookmark-button' data-behaviour='trigger-overlay' type='submit'>
          ...
          <div className='post-show-footer row animated fadeInUp' data-animation='fadeInUp-fadeOutDown'>
            ...
            <div id='responses' className='col-xs-10 col-md-6 col-xs-offset-1 col-md-offset-3 main-content'>
              ...
              <div data-behaviour='responses-list'>
              </div>
            </div>
          </div>
          <div className='post-metadata-bar' data-page='post-metadata-bar'>
            <div className='flex-container is-inView' data-behaviour='animated-metadata'>
              <div className='post-stats flex-container'>
                <div className='like-button-wrapper'>
                  <form className='button_to' method='get' action=''>
                    <button className='like-button' data-behaviour='trigger-overlay' type='submit'>
                      <i className='fa fa-heart-o'></i>
                      <span className='hide-text'>Like</span>
                    </button>
                  </form>
                ...
                <div className='bookmark-button'>
                  <div className='bookmark-button-wrapper'>
                    <form className='button_to' method='get' action=''>
                      <button className='bookmark-button' data-behaviour='trigger-overlay' type='submit'>
                        <span className='icon-bookmark-o'>Bookmark</span>
                        <span className='hide-text'>Bookmark</span>
                      </button>
                    </form>
                  </div>
